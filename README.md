...
3. 在Edge的管理插件页面中打开开发人员模式[管理插件页面](edge://extensions/)
5. 在Edge的油猴插件管理界面中打开**允许用户脚本**[油猴插件管理界面](edge://extensions/?id=iikmkjmpaadaobahmlepeloendndfphd)
...
| 时间      | 版本号 | 描述                            |
| --------- | ------ | ------------------------------- |
| 2026.4.18 | 2.4.2 | 可切换进度条85%连播和看完连播 |
